...
<body>
  <div class="absolute top-4 left-0 w-full z-20">
    <nav class="max-w-[1600px] text-white flex justify-between items-center mx-auto flex-wrap">
      <a href="#" class="w-fit">
        <svg width="130" height="50" class="fill-white ml-4" viewBox="0 0 130.318 50">
          <g transform="translate(-3894 2762)">
            ...
            <path
              ...
              transform="translate(3959 -2728)"></path>
          </g>
        </svg>
      </a>
      <ul class="flex gap-x-8 mx-5 items-center">
        ...
        <li class="cursor-pointer text-[16px] leading-6 font-semibold hover:brightness-75">
          <a href="mailto:khaledhamdy609@gmail.com">Contact us</a>
        </li>
        <li>
  ...
  <header class="flex justify-center items-center relative w-full min-h-[500px] py-20 bg-black bg-opacity-50">
    ...
    <div class="w-full max-w-[630px]">
      ...
      <form method="post" class="flex relative w-full h-12 mt-8 bg-[#f7f7f7] rounded-lg">
        ...
        <button id="form-submit" type="submit"
          class="delay-100 outline-none transition-colors w-14 flex test-[10px] items-center justify-center px-4 hover:text-green-600">
