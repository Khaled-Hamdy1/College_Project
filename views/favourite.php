...
<body>
  ...
  <header class="flex h-[30vh] md:h-[40vh] items-center justify-center bg-header bg-cover">
    <h1
  ...
  <main class="max-w-[95%] mt-10 mx-auto">
    <div class="absolute flex justify-center items-center text-red h-[50vh] font-extrabold text-6xl">
      No Favourites added
    </div>
  </main>
